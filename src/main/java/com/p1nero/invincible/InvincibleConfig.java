...
public class InvincibleConfig {
    ...
    public static final ForgeConfigSpec.IntValue PRESS_PROTECT_TICK = BUILDER.comment("长按保护时间。在新版本的无坚不摧当中，新加入了长按检测，因此发包改为抬手时发包。若长按时间超过长按保护时间，且本节点不存在长按检测条件时，将跳过节点的触发。").defineInRange("press_protect_tick", 110, 0, Integer.MAX_VALUE);
