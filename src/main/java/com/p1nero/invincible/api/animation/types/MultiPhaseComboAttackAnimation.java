...
public class MultiPhaseComboAttackAnimation extends MultiPhaseAttackAnimation {
    public MultiPhaseComboAttackAnimation(float transitionTime, float antic, float contact, float recovery, @Nullable Collider collider, Joint colliderJoint, AnimationAccessor<? extends MultiPhaseComboAttackAnimation> accessor, AssetAccessor<? extends Armature> armature) {
        this(transitionTime, antic, antic, contact, recovery, collider, colliderJoint, accessor, armature);
    }

    public MultiPhaseComboAttackAnimation(float transitionTime, float antic, float preDelay, float contact, float recovery, @Nullable Collider collider, Joint colliderJoint, AnimationAccessor<? extends MultiPhaseComboAttackAnimation> accessor, AssetAccessor<? extends Armature> armature) {
    ...
    public MultiPhaseComboAttackAnimation(float transitionTime, float antic, float contact, float recovery, InteractionHand hand, @Nullable Collider collider, Joint colliderJoint, AnimationAccessor<? extends MultiPhaseComboAttackAnimation> accessor, AssetAccessor<? extends Armature> armature) {
    ...
    public MultiPhaseComboAttackAnimation(float transitionTime, AnimationAccessor<? extends MultiPhaseComboAttackAnimation> accessor, AssetAccessor<? extends Armature> armature, Phase... phases) {
    ...
    public MultiPhaseComboAttackAnimation(float transitionTime, String path, AssetAccessor<? extends Armature> armature, Phase... phases) {
