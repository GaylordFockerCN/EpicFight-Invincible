...
public class MultiPhaseAirSlashAnimation extends MultiPhaseAttackAnimation {
	public MultiPhaseAirSlashAnimation(float transitionTime, float antic, float contact, float recovery, @Nullable Collider collider, Joint colliderJoint, AnimationAccessor<? extends MultiPhaseAirSlashAnimation> accessor, AssetAccessor<? extends Armature> armature) {
		this(transitionTime, antic, antic, contact, recovery, true, collider, colliderJoint, accessor, armature);
	}
	
	public MultiPhaseAirSlashAnimation(float transitionTime, float antic, float preDelay, float contact, float recovery, boolean directional, @Nullable Collider collider, Joint colliderJoint, AnimationAccessor<? extends MultiPhaseAirSlashAnimation> accessor, AssetAccessor<? extends Armature> armature) {
	...
	public MultiPhaseAirSlashAnimation(float transitionTime, AnimationAccessor<? extends MultiPhaseAirSlashAnimation> accessor, AssetAccessor<? extends Armature> armature, Phase... phases) {
