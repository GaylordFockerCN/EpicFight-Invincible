...
public class MultiPhaseDashAttackAnimation extends MultiPhaseAttackAnimation {
    public MultiPhaseDashAttackAnimation(float transitionTime, float antic, float preDelay, float contact, float recovery, @Nullable Collider collider, Joint colliderJoint, AnimationAccessor<? extends MultiPhaseDashAttackAnimation> accessor, AssetAccessor<? extends Armature> armature) {
        this(transitionTime, antic, preDelay, contact, recovery, collider, colliderJoint, accessor, armature, false);
    }

    public MultiPhaseDashAttackAnimation(float transitionTime, float antic, float preDelay, float contact, float recovery, @Nullable Collider collider, Joint colliderJoint, AnimationAccessor<? extends MultiPhaseDashAttackAnimation> accessor, AssetAccessor<? extends Armature> armature, boolean directional) {
    ...
    public MultiPhaseDashAttackAnimation(float transitionTime, AnimationAccessor<? extends MultiPhaseDashAttackAnimation> accessor, AssetAccessor<? extends Armature> armature, Phase... phases) {
