...
public class InvincibleSkillDataKeys {
    ...
    public static final RegistryObject<SkillDataKey<Boolean>> LEFT = DATA_KEYS.register("left", () ->
            SkillDataKey.createSkillDataKey(PacketBufferCodec.BOOLEAN, false, false, ComboBasicAttack.class, SimpleCustomInnateSkill.class, SimpleCustomInnateSkill.class));//a按键是否按下
    public static final RegistryObject<SkillDataKey<Boolean>> RIGHT = DATA_KEYS.register("right", () ->
            SkillDataKey.createSkillDataKey(PacketBufferCodec.BOOLEAN, false, false, ComboBasicAttack.class, SimpleCustomInnateSkill.class));//a按键是否按下
    ...
    public static final RegistryObject<SkillDataKey<Integer>> PARRY_TIMER = DATA_KEYS.register("parry_timer", () ->
            SkillDataKey.createSkillDataKey(PacketBufferCodec.INTEGER, 0, false, ComboBasicAttack.class, SimpleCustomInnateSkill.class));//是否成功格挡计时器
    public static final RegistryObject<SkillDataKey<Integer>> DODGE_SUCCESS_TIMER = DATA_KEYS.register("dodge_success_timer", () ->
            SkillDataKey.createSkillDataKey(PacketBufferCodec.INTEGER, 0, false, ComboBasicAttack.class, SimpleCustomInnateSkill.class));//是否成功闪避计时器
    public static final RegistryObject<SkillDataKey<Integer>> COOLDOWN = DATA_KEYS.register("cooldown", () ->
            SkillDataKey.createSkillDataKey(PacketBufferCodec.INTEGER, 0, false, ComboBasicAttack.class, SimpleCustomInnateSkill.class));//冷却计时器
