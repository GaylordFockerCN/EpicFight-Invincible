...
public class InvincibleConditions {
    ...
    public static final RegistryObject<Supplier<Condition<?>>> MOB_EFFECT = CONDITIONS.register((new ResourceLocation(InvincibleMod.MOD_ID, "mob_effect")).getPath(), () -> MobEffectCondition::new);
    public static final RegistryObject<Supplier<Condition<?>>> ENCHANTMENT = CONDITIONS.register((new ResourceLocation(InvincibleMod.MOD_ID, "enchantment")).getPath(), () -> EnchantmentCondition::new);
